...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "chutiya bot") || (event.body.toLowerCase() == "chutiye bot") || (event.body.toLowerCase() == "chumtiya bot") || (event.body.toLowerCase() == "chumtiye bot")) {
     return api.sendMessage("Hmm... Tu Chutiya sale", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "morning") || (event.body.toLowerCase() == "gm")) {
     return api.sendMessage("UTH gaye kumbhkaran log😮", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "virat") || (event.body.toLowerCase() == "sumit") || (event.body.toLowerCase() == "priyansh") || (event.body.toLowerCase() == "prince")) {
     return api.sendMessage( "Busy HoGa Work Me Main t0o Hun Naw 😘",threadID);

       
   };

   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "info")) {
     return api.sendMessage("https://www.facebook.com/yimelabachaf.2025", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "bot ka admin kon ha")) {
     return api.sendMessage(" Virat.", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "lob you") || (event.body.toLowerCase() == "i love you")) {
   ...
   if ((event.body.toLowerCase() == "@Mêlå") || (event.body.toLowerCase() == "baacha")) {
     return api.sendMessage("Mera bOs Abhi Busy hai Mujhe bolo kiya kam hai", threadID);
   };

  if ((event.body.toLowerCase() == "soja") || (event.body.toLowerCase() == "Sojja") || (event.body.toLowerCase() == "main amrita") || (event.body.toLowerCase() == "main priyansh") || (event.body.toLowerCase() == "main diya")) {
     return api.sendMessage("soja be", threadID);
   };
   mess = "{name}"
